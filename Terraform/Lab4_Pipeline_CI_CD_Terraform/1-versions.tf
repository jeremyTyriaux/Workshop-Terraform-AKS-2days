...
terraform {
  ...
  backend "azurerm" {
   resource_group_name  = "jtyr-RG-AKSCluster"     # mettre ici le nom du resource group de vos ressource
    storage_account_name = "jtyterraformstan"  # /!\ mettre le nom du compte de stockage créer dans le lab 1
    container_name       = "jtyrtfstate"
